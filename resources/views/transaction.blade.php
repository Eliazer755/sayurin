  ...
  <main class="main">
    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.webp);">
      <div class="container position-relative">
        <h1>Belanja kebutuhan Sayur Anda</h1>
        <p>
          Sayur Segar
          -
          Mantap Jiwa</p>
          ...
          <div class="row g-0">
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Brokoli</h3>
                  <p>
                    Gravida sodales condimentum pellen tesq accumsan orci quam
                    sagittis sapie
                  </p>
                </div>
                <button><a href="/products" class="btn-cta">Beli</a></button>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Tomat</h3>
                  <p>
                    Gravida sodales condimentum pellen tesq accumsan orci quam
                    sagittis sapie
                  </p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Wortel</h3>
                  <p>
                    Gravida sodales condimentum pellen tesq accumsan orci quam
                    sagittis sapie
                  </p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Sawi</h3>
                  <p>
                    Gravida sodales condimentum pellen tesq accumsan orci quam
                    sagittis sapie
                  </p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-icon">
                  <img src="images/selada.png" alt="">
                </div>
                <div class="service-item-content">
                  <h3 class="service-heading">Selada</h3>
                  <p>
                    Gravida sodales condimentum pellen tesq accumsan orci quam
                    sagittis sapie
                  </p>
